...
public class WindowBarricade_Enviornment : MonoBehaviour
{
    ...
    public States_Player boardCounter;
    ...
    void Update()
    {
        WindowInteraction_Enviornment window = GetComponent<WindowInteraction_Enviornment>();
